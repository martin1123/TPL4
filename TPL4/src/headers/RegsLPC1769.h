...
#define U1LCR ((volatile uint32_t *) 0x4001000CUL)
#define		U1LCR1	U1LCR[0]

#define UDLL ((volatile uint32_t *) 0x40010000UL)
#define U1DLL UDLL[0]

#define UDLM ((volatile uint32_t *) 0x40010004UL)
#define U1DLM UDLM[0]

#define UTHR ((volatile uint8_t *) 0x40010000UL)
#define U1THR UTHR[0]

#define ULSR ((volatile uint8_t *) 0x40010014UL)
#define U1LSR ULSR[0]
